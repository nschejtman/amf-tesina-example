...
class ListUndocumentedTest extends AsyncFunSuite {
  ...
  private def listUndocumentedFrom(apiPath: String, vendor: Vendor)(assertion: ResultSet => Assertion) = {
  ...
  test("List undocumented nodes in fully-undocumented") {
    listUndocumentedFrom("fully-undocumented/api.raml", Raml10) { undocumentedRS =>
      var count = 0
  ...
  test("List undocumented nodes in fully-documented") {
    listUndocumentedFrom("fully-documented/api.raml", Raml10) { undocumentedRS =>
      assert(!undocumentedRS.hasNext)
    }
  }

  test("List undocumented nodes in partially-documented") {
    listUndocumentedFrom("partially-documented/api.raml", Raml10) { undocumentedRS =>
